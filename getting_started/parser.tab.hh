...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TYPE_BOOLEAN = 278,            // TYPE_BOOLEAN
    IF = 279,                      // IF
    ELSE = 280,                    // ELSE
    WHILE = 281,                   // WHILE
    PRINTLN = 282,                 // PRINTLN
    ASSIGN = 283,                  // ASSIGN
    LOGICAND = 284,                // LOGICAND
    LOGICOR = 285,                 // LOGICOR
    LT = 286,                      // LT
    GT = 287,                      // GT
    EQUAL = 288,                   // EQUAL
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_COMMA = 20,                            // COMMA
        S_RETURN = 21,                           // RETURN
        S_TYPE_INT = 22,                         // TYPE_INT
        S_TYPE_BOOLEAN = 23,                     // TYPE_BOOLEAN
        S_IF = 24,                               // IF
        S_ELSE = 25,                             // ELSE
        S_WHILE = 26,                            // WHILE
        S_PRINTLN = 27,                          // PRINTLN
        S_ASSIGN = 28,                           // ASSIGN
        S_LOGICAND = 29,                         // LOGICAND
        S_LOGICOR = 30,                          // LOGICOR
        S_LT = 31,                               // LT
        S_GT = 32,                               // GT
        S_EQUAL = 33,                            // EQUAL
        S_DIVOP = 34,                            // DIVOP
        ...
        S_root = 44,                             // root
        S_goal = 45,                             // goal
        S_main_class = 46,                       // main_class
        S_n_class_declarations = 47,             // n_class_declarations
        S_class_declaration = 48,                // class_declaration
        S_n_var_declarations = 49,               // n_var_declarations
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_SC (std::string v)
      {
        return symbol_type (token::SC, std::move (v));
      }
#else
      static
      symbol_type
      make_SC (const std::string& v)
      {
        return symbol_type (token::SC, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_LOGICAND (std::string v)
      {
        return symbol_type (token::LOGICAND, std::move (v));
      }
#else
      static
      symbol_type
      make_LOGICAND (const std::string& v)
      {
        return symbol_type (token::LOGICAND, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_LOGICOR (std::string v)
      {
        return symbol_type (token::LOGICOR, std::move (v));
      }
#else
      static
      symbol_type
      make_LOGICOR (const std::string& v)
      {
        return symbol_type (token::LOGICOR, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
